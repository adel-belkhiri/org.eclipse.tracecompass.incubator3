...
public class DpdkVhostUserPacketRateTreeViewer extends AbstractSelectTreeViewer {
     ...
     *            Parent composite
     */
    public DpdkVhostUserPacketRateTreeViewer(Composite parent) {
        super(parent, 1, VhostPacketRateDataProvider.ID);
    ...
    protected ITmfTreeColumnDataProvider getColumnDataProvider() {
        return () -> {
            return ImmutableList.of(
                    createColumn(Messages.DpdkVhostUserPacketRateTreeViewer_DevName, Comparator.comparing(TmfGenericTreeEntry::getName)),
                    new TmfTreeColumnData(Messages.DpdkVhostUserPacketRateTreeViewer_Legend));
        };
    }
