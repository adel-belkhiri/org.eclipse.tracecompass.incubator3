 ...
 * @author Adel
 */
public class DpdkLpmRuleHitRateViewer extends TmfFilteredXYChartViewer {
     ...
     */
    public DpdkLpmRuleHitRateViewer(@Nullable Composite parent, TmfXYChartSettings settings) {
        super(parent, settings, DpdkLpmPerRuleLookupHitRateDataProvider.ID);
