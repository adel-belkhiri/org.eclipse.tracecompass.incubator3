 ...
 * @author Adel
 */
public class DpdkPipelineSwQueueOccupancyViewer extends TmfFilteredXYChartViewer {
     ...
     */
    public DpdkPipelineSwQueueOccupancyViewer(@Nullable Composite parent, TmfXYChartSettings settings) {
        super(parent, settings, PipelineRingQueueOccupancyDataProvider.ID);
