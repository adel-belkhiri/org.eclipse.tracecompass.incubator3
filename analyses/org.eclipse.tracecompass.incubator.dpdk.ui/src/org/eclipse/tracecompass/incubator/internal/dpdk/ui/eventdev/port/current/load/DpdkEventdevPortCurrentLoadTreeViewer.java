...
import org.eclipse.tracecompass.incubator.internal.dpdk.core.eventdev.analysis.EventDevPortCurrentLoadDataProvider;
 ...
 * @author adel
 */
public class DpdkEventdevPortCurrentLoadTreeViewer extends AbstractSelectTreeViewer2 {
     ...
     *            Parent composite
     */
    public DpdkEventdevPortCurrentLoadTreeViewer(Composite parent) {
        super(parent, 1, EventDevPortCurrentLoadDataProvider.ID);
    ...
    protected ITmfTreeColumnDataProvider getColumnDataProvider() {
        return () -> {
            return ImmutableList.of(
                    createColumn(Messages.DpdkEventdevPortCurrentLoadTreeViewer_EventDevName, Comparator.comparing(TmfGenericTreeEntry::getName)),
                    new TmfTreeColumnData(Messages.DpdkEventdevPortCurrentLoadTreeViewer_Legend));
        };
    }
