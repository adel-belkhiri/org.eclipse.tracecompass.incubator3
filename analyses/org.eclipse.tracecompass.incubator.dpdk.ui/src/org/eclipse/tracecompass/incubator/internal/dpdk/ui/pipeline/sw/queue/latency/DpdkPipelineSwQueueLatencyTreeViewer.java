 ...
 * @author adel
 */
public class DpdkPipelineSwQueueLatencyTreeViewer extends AbstractSelectTreeViewer2 {
     ...
     *            Parent composite
     */
    public DpdkPipelineSwQueueLatencyTreeViewer(Composite parent) {
        super(parent, 1, PipelineRingQueueLatencyDataProvider.ID);
    ...
    protected ITmfTreeColumnDataProvider getColumnDataProvider() {
        return () -> {
            return ImmutableList.of(
                    createColumn(Messages.DpdkPipelineSwQueueLatencyTreeViewer_DevName, Comparator.comparing(TmfGenericTreeEntry::getName)),
                    new TmfTreeColumnData(Messages.DpdkPipelineSwQueueLatencyTreeViewer_Legend));
        };
    }
