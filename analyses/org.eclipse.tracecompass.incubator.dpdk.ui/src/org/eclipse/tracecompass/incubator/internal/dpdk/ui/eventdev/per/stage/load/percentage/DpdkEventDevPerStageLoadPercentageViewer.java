 ...
 * @author Adel
 */
public class DpdkEventDevPerStageLoadPercentageViewer extends TmfFilteredXYChartViewer {
     ...
     */
    public DpdkEventDevPerStageLoadPercentageViewer(@Nullable Composite parent, TmfXYChartSettings settings) {
        super(parent, settings, EventDevPerStageLoadPercentageDataProvider.ID);
