 ...
 * @author adel
 */
public class DpdkEventdevPortBusynessTreeViewer extends AbstractSelectTreeViewer2 {
     ...
     *            Parent composite
     */
    public DpdkEventdevPortBusynessTreeViewer(Composite parent) {
        super(parent, 1, EventdevPortsBusynessDataProvider.ID);
