 ...
 * @author Adel
 */
public class DpdkEventdevRingOccupationView extends TmfChartView {

    /** ID string */
    public static final String ID = "org.eclipse.tracecompass.incubator.internal.dpdk.ui.eventdev.ring.occupation.view"; //$NON-NLS-1$
    private static final double RESOLUTION = 0.3;

    /**
     * Constructor
     */
    public DpdkEventdevRingOccupationView() {
    ...
    protected TmfXYChartViewer createChartViewer(@Nullable Composite parent) {
        ...
        return new DpdkEventdevRingOccupationViewer(parent, settings);
    }

    @Override
    protected @NonNull TmfViewer createLeftChildViewer(@Nullable Composite parent) {
        return new DpdkEventdevRingOccupationTreeViewer(Objects.requireNonNull(parent));
    }
}
