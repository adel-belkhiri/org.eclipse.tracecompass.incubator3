...
import org.eclipse.tracecompass.incubator.internal.dpdk.core.eventdev.analysis.EventDevRingBufferOccupationDataProvider;
 ...
 * @author adel
 */
public class DpdkEventdevRingOccupationTreeViewer extends AbstractSelectTreeViewer2 {
     ...
     *            Parent composite
     */
    public DpdkEventdevRingOccupationTreeViewer(Composite parent) {
        super(parent, 1, EventDevRingBufferOccupationDataProvider.ID);
    ...
    protected ITmfTreeColumnDataProvider getColumnDataProvider() {
        return () -> {
            return ImmutableList.of(
                    createColumn(Messages.DpdkEventDevRingOccupationTreeViewer_EventDevName, Comparator.comparing(TmfGenericTreeEntry::getName)),
                    new TmfTreeColumnData(Messages.DpdkEventDevRingOccupationTreeViewer_Legend));
        };
    }
