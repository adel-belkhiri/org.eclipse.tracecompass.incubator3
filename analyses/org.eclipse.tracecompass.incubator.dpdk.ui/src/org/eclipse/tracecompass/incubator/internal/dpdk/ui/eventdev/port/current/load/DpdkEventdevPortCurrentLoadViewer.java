 ...
 * @author Adel
 */
public class DpdkEventdevPortCurrentLoadViewer extends TmfFilteredXYChartViewer {
     ...
     */
    public DpdkEventdevPortCurrentLoadViewer(@Nullable Composite parent, TmfXYChartSettings settings) {
        super(parent, settings, EventDevPortCurrentLoadDataProvider.ID);
