 ...
 * @author Adel
 */
public class DpdkEventdevRingOccupationViewer extends TmfFilteredXYChartViewer {
     ...
     */
    public DpdkEventdevRingOccupationViewer(@Nullable Composite parent, TmfXYChartSettings settings) {
        super(parent, settings, EventDevRingBufferOccupationDataProvider.ID);
