 ...
 * @author Adel
 */
public class DpdkEventDevInflightCreditViewer extends TmfFilteredXYChartViewer {
     ...
     */
    public DpdkEventDevInflightCreditViewer(@Nullable Composite parent, TmfXYChartSettings settings) {
        super(parent, settings, EventDevInflightCreditDataProvider.ID);
