...
import org.eclipse.tracecompass.incubator.internal.dpdk.core.eventdev.analysis.EventDevPortEnqueueDequeueRateDataProvider;
 ...
 * @author adel
 */
public class DpdkEventDevEnqueueDequeueRateTreeViewer extends AbstractSelectTreeViewer2 {
     ...
     *            Parent composite
     */
    public DpdkEventDevEnqueueDequeueRateTreeViewer(Composite parent) {
        super(parent, 1, EventDevPortEnqueueDequeueRateDataProvider.ID);
    ...
    protected ITmfTreeColumnDataProvider getColumnDataProvider() {
        return () -> {
            return ImmutableList.of(
                    createColumn(Messages.DpdkEventDevEnqueueDequeueRateTreeViewer_EventDevName, Comparator.comparing(TmfGenericTreeEntry::getName)),
                    new TmfTreeColumnData(Messages.DpdkEventDevEnqueueDequeueRateTreeViewer_Legend));
        };
    }
