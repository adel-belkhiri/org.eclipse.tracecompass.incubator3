 ...
 * @author Adel
 */
public class DpdkFlowClassifierLookupHitRateViewer extends TmfFilteredXYChartViewer {
     ...
     */
    public DpdkFlowClassifierLookupHitRateViewer(@Nullable Composite parent, TmfXYChartSettings settings) {
        super(parent, settings, ClassifierPerRuleLookupHitRateDataProvider.ID);
