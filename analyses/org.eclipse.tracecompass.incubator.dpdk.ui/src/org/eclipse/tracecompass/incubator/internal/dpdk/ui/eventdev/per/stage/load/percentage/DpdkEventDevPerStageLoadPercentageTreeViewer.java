 ...
 * @author adel
 */
public class DpdkEventDevPerStageLoadPercentageTreeViewer extends AbstractSelectTreeViewer2 {
     ...
     *            Parent composite
     */
    public DpdkEventDevPerStageLoadPercentageTreeViewer(Composite parent) {
        super(parent, 1, EventDevPerStageLoadPercentageDataProvider.ID);
    ...
    protected ITmfTreeColumnDataProvider getColumnDataProvider() {
        return () -> {
            return ImmutableList.of(
                    createColumn(Messages.DpdkEventDevPerStageLoadPercentageTreeViewer_EventDevName, Comparator.comparing(TmfGenericTreeEntry::getName)),
                    new TmfTreeColumnData(Messages.DpdkEventDevPerStageLoadPercentageTreeViewer_Legend));
        };
    }
