 ...
 * @author Adel
 */
public class DpdkVhostUserAvailDescrViewer extends TmfFilteredXYChartViewer {
     ...
     */
    public DpdkVhostUserAvailDescrViewer(@Nullable Composite parent, TmfXYChartSettings settings) {
        super(parent, settings, VhostAvailableDescriptorsDataProvider.ID);
