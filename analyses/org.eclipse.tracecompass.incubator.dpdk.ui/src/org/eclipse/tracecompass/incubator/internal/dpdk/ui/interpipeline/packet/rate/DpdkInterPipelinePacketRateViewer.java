 ...
 * @author Adel
 */
public class DpdkInterPipelinePacketRateViewer extends TmfFilteredXYChartViewer {
     ...
     */
    public DpdkInterPipelinePacketRateViewer(@Nullable Composite parent, TmfXYChartSettings settings) {
        super(parent, settings, InterPipelinesPacketRateDataProvider.ID);
