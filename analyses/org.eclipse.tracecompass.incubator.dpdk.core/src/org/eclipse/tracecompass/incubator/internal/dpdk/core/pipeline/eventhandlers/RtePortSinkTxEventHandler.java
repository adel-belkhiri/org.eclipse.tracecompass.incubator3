 ...
 *
 */
public class RtePortSinkTxEventHandler extends DpdkEventHandler {
     ...
     */
    public RtePortSinkTxEventHandler(@NonNull DpdkPipelineAnalysisEventLayout layout, DpdkPipelineStateProvider stateProvider) {
