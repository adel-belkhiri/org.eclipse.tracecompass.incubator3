 ...
 *
 */
public class SwScheduleParallelToCqEventHandler extends DpdkEventHandler {
     ...
     */
    public SwScheduleParallelToCqEventHandler(@NonNull DpdkEventDevAnalysisEventLayout layout, DpdkEventDevStateProvider stateProvider) {
    ...
    public void handleEvent(ITmfStateSystemBuilder ss, ITmfEvent event) throws AttributeNotFoundException {
        ...
        if (backendId == null || portId == null || queueId == null || flowId == null) {
            throw new IllegalArgumentException(layout.eventSwScheduleParallelToCq() + " event does not have expected fields"); //$NON-NLS-1$ ;
        }
        ...
        if(device != null) {
            ...
            if(queue != null) {
                queue.transferToPort(portId, flowId, ts);
            }
            //port.pushToRingBufferCq(1, ts);
        }
    }
