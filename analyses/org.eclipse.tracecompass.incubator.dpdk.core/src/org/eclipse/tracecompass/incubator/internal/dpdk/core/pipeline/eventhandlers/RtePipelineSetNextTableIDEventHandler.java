 ...
 *
 */
public class RtePipelineSetNextTableIDEventHandler extends DpdkEventHandler {
     ...
     */
    public RtePipelineSetNextTableIDEventHandler(@NonNull DpdkPipelineAnalysisEventLayout layout, DpdkPipelineStateProvider stateProvider) {
    ...
    public void handleEvent(ITmfStateSystemBuilder ss, ITmfEvent event) throws AttributeNotFoundException {
        ...
        Integer nextTableIdx = content.getFieldValue(Integer.class, layout.fieldNextTableIdx());

        if (pipeId == null || tableIdx == null || nextTableIdx == null) {
            throw new IllegalArgumentException(layout.eventRtePipelineSetNextTableID() + " event does not have expected fields");
        }
        ...
        if(pipeline != null){
            ...
            if(table != null) {
                table.setChildTableID(nextTableIdx, ts);
            }
        }
    }
