 ...
 *
 */
public class DpdkServiceLcoreReadyEventHandler extends DpdkEventHandler {
     ...
     * @param stateProvider :
     */
    public DpdkServiceLcoreReadyEventHandler(@NonNull DpdkAnalysisEventLayout layout, DpdkCoreStateProvider stateProvider) {
        super(layout);
    ...
    public void handleEvent(ITmfStateSystemBuilder ss, ITmfEvent event) throws AttributeNotFoundException {
        ...
        if (coreId == null) {
            throw new IllegalArgumentException(layout.eventServiceLcoreReady() + " event does not have expected fields"); //$NON-NLS-1$ ;
        }
