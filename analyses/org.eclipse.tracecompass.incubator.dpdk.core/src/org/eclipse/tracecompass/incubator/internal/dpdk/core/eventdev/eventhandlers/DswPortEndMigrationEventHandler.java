 ...
 *
 */
public class DswPortEndMigrationEventHandler extends DpdkEventHandler {
    ...
    public DswPortEndMigrationEventHandler(@NonNull DpdkEventDevAnalysisEventLayout layout, DpdkEventDevStateProvider stateProvider) {
    ...
    public void handleEvent(ITmfStateSystemBuilder ss, ITmfEvent event) throws AttributeNotFoundException {
        ...
        if(device != null) {
            ...
            if(port != null) {
                port.updateStatus(PortStatus.IDLE, ts);
            }
        }
    }
