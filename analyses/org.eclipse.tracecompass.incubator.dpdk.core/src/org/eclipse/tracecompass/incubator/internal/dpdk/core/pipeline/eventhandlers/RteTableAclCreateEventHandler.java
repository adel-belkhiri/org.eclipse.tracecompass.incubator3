...
public class RteTableAclCreateEventHandler extends DpdkEventHandler {
     ...
     */
    public RteTableAclCreateEventHandler(@NonNull DpdkPipelineAnalysisEventLayout layout, DpdkPipelineStateProvider stateProvider) {
    ...
    public void handleEvent(ITmfStateSystemBuilder ss, ITmfEvent event) throws AttributeNotFoundException {
        ...
        if (tblName == null || tbl == null) {
            throw new IllegalArgumentException(layout.eventRteTableAclCreate() +
                    " event does not have expected fields"); //$NON-NLS-1$ ;
        }

        fPipelineStateProvier.addTable(tblName, tbl, DpdkTableTypeEnum.ACL);
    }
