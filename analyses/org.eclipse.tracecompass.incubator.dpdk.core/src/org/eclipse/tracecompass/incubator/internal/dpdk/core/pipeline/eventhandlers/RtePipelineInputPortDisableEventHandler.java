 ...
 *
 */
public class RtePipelineInputPortDisableEventHandler extends DpdkEventHandler {
     ...
     */
    public RtePipelineInputPortDisableEventHandler(@NonNull DpdkPipelineAnalysisEventLayout layout, DpdkPipelineStateProvider stateProvider) {
    ...
    public void handleEvent(ITmfStateSystemBuilder ss, ITmfEvent event) throws AttributeNotFoundException {
        ...
        if (portId == null || pipeId == null) {
            throw new IllegalArgumentException(layout.eventRtePipelineInputPortDisable() +
