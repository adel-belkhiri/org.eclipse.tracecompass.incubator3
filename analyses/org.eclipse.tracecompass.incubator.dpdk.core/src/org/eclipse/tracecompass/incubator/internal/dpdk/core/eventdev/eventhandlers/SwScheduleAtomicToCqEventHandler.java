 ...
 *
 */
public class SwScheduleAtomicToCqEventHandler extends DpdkEventHandler {
     ...
     */
    public SwScheduleAtomicToCqEventHandler(@NonNull DpdkEventDevAnalysisEventLayout layout, DpdkEventDevStateProvider stateProvider) {
