 ...
 *
 */
public class DswPortUpdateLoadEventHandler extends DpdkEventHandler {
     ...
     */
    public DswPortUpdateLoadEventHandler(@NonNull DpdkEventDevAnalysisEventLayout layout, DpdkEventDevStateProvider stateProvider) {
    ...
    public void handleEvent(ITmfStateSystemBuilder ss, ITmfEvent event) throws AttributeNotFoundException {
        ...
        Integer portLoad = content.getFieldValue(Integer.class, layout.fieldCurrentLoad());

        if (dsw == null || portId == null || portLoad == null) {
            throw new IllegalArgumentException(layout.eventDswPortLoadUpdate()+ " event does not have expected fields"); //$NON-NLS-1$ ;
        }
