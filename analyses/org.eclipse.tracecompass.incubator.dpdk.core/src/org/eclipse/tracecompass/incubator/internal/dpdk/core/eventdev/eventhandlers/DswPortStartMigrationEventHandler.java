 ...
 *
 */
public class DswPortStartMigrationEventHandler extends DpdkEventHandler {
     ...
     */
    public DswPortStartMigrationEventHandler(@NonNull DpdkEventDevAnalysisEventLayout layout, DpdkEventDevStateProvider stateProvider) {
    ...
    public void handleEvent(ITmfStateSystemBuilder ss, ITmfEvent event) throws AttributeNotFoundException {
        ...
        if (dsw == null || srcPortId == null || queueId == null || hashFlow == null) {
            throw new IllegalArgumentException(layout.eventDswPortStartMigration() + " event does not have expected fields"); //$NON-NLS-1$ ;
        }
        ...
        if(device != null) {
            ...
            if(port != null) {
                port.updateStatus(PortStatus.PAUSING, ts);
            }
        }
    }
