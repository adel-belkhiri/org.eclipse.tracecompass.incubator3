 ...
 *
 */
public class SwUnmapFlowFromPortAtomicQueueEventHandler extends DpdkEventHandler {
     ...
     */
    public SwUnmapFlowFromPortAtomicQueueEventHandler(@NonNull DpdkEventDevAnalysisEventLayout layout, DpdkEventDevStateProvider stateProvider) {
    ...
    public void handleEvent(ITmfStateSystemBuilder ss, ITmfEvent event) throws AttributeNotFoundException {
        ...
        if(device != null) {
            ...
            if(queue != null) {
                queue.unmapFlowFromPort(portId, flowId, ts);
            }
        }
    }
