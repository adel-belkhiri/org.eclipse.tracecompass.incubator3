 ...
 *
 */
public class RtePortEthdevReaderRxEventHandler extends DpdkEventHandler {
     ...
     */
    public RtePortEthdevReaderRxEventHandler(@NonNull DpdkPipelineAnalysisEventLayout layout, DpdkPipelineStateProvider stateProvider) {
    ...
    public void handleEvent(ITmfStateSystemBuilder ss, ITmfEvent event) throws AttributeNotFoundException {
        ...
        if (portId == null || nbRxPkts == null /*|| nbZeroPolls == null*/) {
            throw new IllegalArgumentException(layout.eventRtePortEthdevReaderRx()+ " event does not have expected fields"); //$NON-NLS-1$ ;
        }
