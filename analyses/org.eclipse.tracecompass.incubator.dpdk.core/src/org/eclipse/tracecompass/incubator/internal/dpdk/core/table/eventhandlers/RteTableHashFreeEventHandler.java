 ...
 *
 */
public class RteTableHashFreeEventHandler extends DpdkEventHandler {
     ...
     */
    public RteTableHashFreeEventHandler(@NonNull DpdkTableAnalysisEventLayout layout, DpdkTableStateProvider stateProvider) {
    ...
    public void handleEvent(ITmfStateSystemBuilder ss, ITmfEvent event) throws AttributeNotFoundException {
        ...
        if (tbl == null) {
            throw new IllegalArgumentException(layout.eventRteTableHashCuckooFree() + " event does not have expected fields"); //$NON-NLS-1$ ;
        }
