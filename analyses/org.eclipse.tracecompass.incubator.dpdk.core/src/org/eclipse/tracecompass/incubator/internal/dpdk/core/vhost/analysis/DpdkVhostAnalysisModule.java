 ...
 */
public class DpdkVhostAnalysisModule extends TmfStateSystemAnalysisModule {

    /** The ID of this analysis module */
    public static final String ID = "org.eclipse.tracecompass.incubator.dpdk.vhost.analysis"; //$NON-NLS-1$
    ...
    protected ITmfStateProvider createStateProvider() {
        ...
        if (trace instanceof TmfTrace) {
            return new DpdkVhostStateProvider((TmfTrace)trace, new DpdkVhostAnalysisEventLayout(), ID);
        }
