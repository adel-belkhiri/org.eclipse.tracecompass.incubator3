 ...
 * @author Adel
 */
public class OvsRevalidationViewer extends TmfFilteredXYChartViewer {
     ...
     */
    public OvsRevalidationViewer(@Nullable Composite parent, TmfXYChartSettings settings) {
        super(parent, settings, OvsRevalidationDataProvider.ID);
