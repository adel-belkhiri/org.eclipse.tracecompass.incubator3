 ...
 * @author Adel
 */
public class OvsUpcallRateViewer extends TmfFilteredXYChartViewer {
     ...
     */
    public OvsUpcallRateViewer(@Nullable Composite parent, TmfXYChartSettings settings) {
        super(parent, settings, OvsUpcallRateDataProvider.ID);
