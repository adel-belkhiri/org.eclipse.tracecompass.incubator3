 ...
 * @author adel
 */
public class OvsPacketRateTreeViewer extends AbstractSelectTreeViewer {
     ...
     *            Parent composite
     */
    public OvsPacketRateTreeViewer(Composite parent) {
        super(parent, 1, OvsPacketRateDataProvider.ID);
    ...
    protected ITmfTreeColumnDataProvider getColumnDataProvider() {
        return () -> {
            return ImmutableList.of(
                    createColumn(Messages.OvsPacketRateTreeViewer_DevName, Comparator.comparing(TmfGenericTreeEntry::getName)),
                    new TmfTreeColumnData(Messages.OvsPacketRateTreeViewer_Legend));
        };
    }
