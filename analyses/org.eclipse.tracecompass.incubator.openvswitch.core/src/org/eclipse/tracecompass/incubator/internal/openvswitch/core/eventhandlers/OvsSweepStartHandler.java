 ...
 *
 */
public class OvsSweepStartHandler extends OpenvSwitchEventHandler {

    /**
     * @param layout :
     * @param stateProvider :
     */
    public OvsSweepStartHandler(@NonNull IOpenvSwitchAnalysisEventLayout layout, OvsRevalidationStateProvider stateProvider) {
        super(layout);
    }
    ...
    public void handleEvent(@NonNull ITmfStateSystemBuilder ss, @NonNull ITmfEvent event) throws AttributeNotFoundException {
        ...
        ss.modifyAttribute(ts, "sweeping", revalidatorQuark); //$NON-NLS-1$
    }
