 ...
 */
public class OpenvSwitchDatapathInterfaceAnalysisModule extends TmfStateSystemAnalysisModule {

    /** The ID of this analysis module */
    public static final String ID = "org.eclipse.tracecompass.incubator.internal.openvswitch.core.datapath.interface.analysis"; //$NON-NLS-1$
    ...
    protected ITmfStateProvider createStateProvider() {
        ...
        if (trace instanceof TmfExperiment) {
            return new OvsUpcallsStateProvider((TmfExperiment) trace, new IOpenvSwitchAnalysisEventLayout(), ID);
        }
