...
/**
 * Analysis Module for OpenvSwitch Flows
 *
 * @author Adel Belkhiri
 */
public class OpenvSwitchFlowsAnalysisModule extends TmfStateSystemAnalysisModule {

    /** The ID of this analysis module */
    public static final String ID = "org.eclipse.tracecompass.incubator.internal.openvswitch.core.flows.analysis"; //$NON-NLS-1$
    ...
    protected ITmfStateProvider createStateProvider() {
        ...
        if (trace instanceof TmfExperiment) {
            return new OvsFlowsStateProvider((TmfExperiment) trace, new IOpenvSwitchAnalysisEventLayout(), ID);
        }
